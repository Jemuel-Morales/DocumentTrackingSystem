    ...
    public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<EStatus>().HasData(
                new EStatus() { Id = 1, StatusName = "Under Review" },
                new EStatus() { Id = 2, StatusName = "Pending Approval" },
                new EStatus() { Id = 3, StatusName = "Approved" },
                new EStatus() { Id = 4, StatusName = "Rejected" },
                new EStatus() { Id = 5, StatusName = "On Hold" },
                new EStatus() { Id = 6, StatusName = "In Progress" },
                new EStatus() { Id = 7, StatusName = "Completed" }
                );
